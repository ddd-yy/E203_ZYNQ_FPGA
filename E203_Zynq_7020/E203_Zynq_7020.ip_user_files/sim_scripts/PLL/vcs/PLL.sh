...
#
# Generated by Vivado on Fri Feb 28 10:49:43 +0800 2025
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../E203_Zynq_7020.srcs/sources_1/ip/PLL/PLL_clk_wiz.v" \
    "$ref_dir/../../../../E203_Zynq_7020.srcs/sources_1/ip/PLL/PLL.v" \
  2>&1 | tee -a vlogan.log

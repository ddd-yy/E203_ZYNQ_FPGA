...
#
# Generated by Vivado on Thu Feb 27 20:45:51 CST 2025
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../e203_fpga_proj.srcs/sources_1/ip/PLL/PLL_clk_wiz.v" \
    "$ref_dir/../../../../e203_fpga_proj.srcs/sources_1/ip/PLL/PLL.v" \
  2>&1 | tee -a vlogan.log
